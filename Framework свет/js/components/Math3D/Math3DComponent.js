    ...
    changeFigures(value) {
        ...
        switch (value) {
            ...
            case "twoSheetedHyperboloid":
                this.figures = [(new Figure).twoSheetedHyperboloid()];
                break;
            case "oneSheetedHyperboloid":
                this.figures = [(new Figure).oneSheetedHyperboloid()];
                break;
            case "ellipsoid":
                this.figures = [(new Figure).ellipsoid()];
                break;
            case "sphere":
                this.figures = [(new Figure).sphere()];
                break;
            case "cylinder":
                this.figures = [(new Figure).cylinder()];
                break;
            case "parabolicCylinder":
                this.figures = [(new Figure).parabolicCylinder()];
                break;
            case "hyperbolicCylinder":
                this.figures =[(new Figure).hyperbolicCylinder()];
                break;
            case "hyperbolicParaboloid":
                this.figures = [(new Figure).hyperbolicParaboloid()];
                break;
            case "ellipticalCylinder":
                this.figures = [(new Figure).ellipticalCylinder()];
                break;
            case "ellipticalParaboloid":
                this.figures = [(new Figure).ellipticalParaboloid()];
                break;
                case "Tor":
                    this.figures = [(new Figure).Tor()];
                    break;    
        }
